...
public class BusquedaTabuEjecutable {
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		int numeroCiclos = 10000; // Repeticiones - Ciclos de busqueda
		
		boolean intercambiosCompletos = false; // Parametro para activar, o no, una busqueda en todos los mejores
		int limiteIntercambios = 10; // Si el flag anterior es "false", aca se puede especificar el limite.
		
		boolean diversifico = true; // Parametro donde especifico si diversifico o no
		int ciclosDiversificacion = 1000; // Si el anterior es "Si", se diversificara en este periodo
		
		boolean intensifico = true; // Parametro donde especifico si intensifico o no
		int numeroSolucionesSinMejorar = 500; // Si el anterior es "Si", se intensificara cuando hayan 10 soluciones sin mejorar
		...
		Salida.excel("C:\\Users\\User\\Desktop\\Output\\" + tenor + "-" + numeroCiclos + "-" + limiteIntercambios + "-" + ciclosDiversificacion + "-" + 
		numeroSolucionesSinMejorar + "-" + porcentajeIntensificacion + ".xlsx", BusquedaTabu.solucionesEncontradas, BusquedaTabu.costosEncontrados, BusquedaTabu.solucionesEncontradasTimestamp, BusquedaTabu.mejoresSolucionesHistoricas, BusquedaTabu.mejoresCostosEncontrados, BusquedaTabu.mejoresSolucionesHistoricasTimestamp);
	
		//Salida.grafico("Tenor: " + tenor + " | Mejor Resultado: " + QAP.calculoCosto(BusquedaTabu.mejorSolucionHistorica), "Todas", "Mejor", BusquedaTabu.solucionesEncontradas, BusquedaTabu.mejoresSolucionesHistoricas);
	}
}
