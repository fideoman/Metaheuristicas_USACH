...
public class TemplamientoSimuladoEjecutable {
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		double temperaturaInicial = 1000; // Temperatura Inicial
		int porcentajeTasaDescenso = 1; // Porcentaje de tasa de descenso, en entero. Ej: 1 -> 1%
		// De 12:
		...
		QAP.grafico("T ini: " + temperaturaInicial + " | %Des: " + porcentajeTasaDescenso + "% | Mejor Resultado: " + QAP.calculoCosto(TemplamientoSimulado.mejorSolucionHistorica), "Todas", "Mejor", TemplamientoSimulado.solucionesEncontradas, TemplamientoSimulado.mejoresSolucionesHistoricas);
	}
}
